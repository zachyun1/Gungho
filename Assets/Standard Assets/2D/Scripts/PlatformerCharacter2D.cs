...
namespace UnityStandardAssets._2D
{
    public class PlatformerCharacter2D : MonoBehaviour
    {
        ...
        public void Move(float move, bool crouch, bool jump)
        {
            ...
            if (!crouch && m_Anim.GetBool("Crouch") && !m_Attacking)
            {
            ...
            if ((m_Grounded || m_AirControl) && !m_Attacking)
            {
            ...
            if (m_Grounded && jump && m_Anim.GetBool("Ground") && !m_Attacking)
            {
        ...
        {
            if(m_Attacking || !m_Grounded || attackType == 0)
                return;
        ...
        private void AttackHitCheck()
        {
            ...
            for (int i = 0; i < colliders.Length; i++)
            {
                ...
                {
                    colliders[i].gameObject.GetComponent<EnemyActor>().TakeDamage(5);
                    print("Enemy Hit");
                }
            }
        }
